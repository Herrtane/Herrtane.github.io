...
**Return To Library**는 libc 함수 하나를 호출하여 NX를 우회하는 가장 기본적인 기법이라면, **Return Oriented Programming**는 이를 확장하여, 여러 가젯 체인을 구성하는 방법이다. 즉, RTL을 일반화한 형태가 바로 ROP라고 보아도 무방하다.
